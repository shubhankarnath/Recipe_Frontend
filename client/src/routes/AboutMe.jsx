        ...
        <>
          ...
          <div className="aboutMeContainer">
            <div className="avatarContainer">
              <Avatar size="200" round={true} src={pic} />
            </div>
            {/* <div className="nameContainer">Shubhankar</div> */}
            <div className="aboutMeText">
              <p>
                Welcome to my recipe website! My name is Shubhankar, and I'm the
            ...
            <div className="socialMediaLinkContainer">
              <a
                href={"https://www.linkedin.com/in/shubhankar-nath-119a4b205/"}
                target="_black"
              ...
              <a
                href={"https://www.instagram.com/____shubhankar____/"}
                target="_black"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
              ...
              <a
                href={"https://twitter.com/shubhankar1245"}
                target="_black"
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon
              ...
              <a
                href={"https://github.com/shubhankarnath"}
                target="_black"
                rel="noopener noreferrer"
              >
              ...
              <a
                href={"https://leetcode.com/shubhankarr/"}
                target="_black"
                rel="noopener noreferrer"
              >
